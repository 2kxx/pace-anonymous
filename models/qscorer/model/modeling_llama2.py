...
from diffusers.models.attention_dispatch import flash_attn_varlen_func, flash_attn_func
...
def apply_rotary_pos_emb(q, k, cos, sin, position_ids):
    ...
    # cos: [batch_size, seq_len, head_dim] -> [batch_size, 1, seq_len, head_dim]
...
def repeat_kv(hidden_states: torch.Tensor, n_rep: int) -> torch.Tensor:
    """这是针对 Multi-Query Attention 的辅助函数"""
